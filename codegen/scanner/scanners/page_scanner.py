...
from ast_utils import get_node_text, find_class_declarations
from extractors.class_info import  extract_class_inheritance
from extractors.function_calls import extract_function_calls_and_data
...
def scan_multiple_directories(root_dirs, output_dir="codegen/output"):
    """
