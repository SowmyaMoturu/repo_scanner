...
def map_steps_to_defs(scenarios, step_defs_path="scanner/scan_split/all_step_definitions.json"):
...
def build_feature_map(feature_dir, output_dir="scanner/scan_split"):
